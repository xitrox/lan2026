...
// Use NON_POOLING (Session mode) with single connection
// This avoids "max clients" error while maintaining compatibility
let connectionString;
let connectionType;

if (process.env.POSTGRES_URL_NON_POOLING) {
  connectionString = process.env.POSTGRES_URL_NON_POOLING;
  connectionType = 'POSTGRES_URL_NON_POOLING (Session mode, max: 1)';
